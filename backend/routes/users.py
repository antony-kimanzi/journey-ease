...
CORS(user_bp, supports_credentials=True, origins=["https://journey-ease-site.vercel.app"])
...
def add_cors_headers(response):
    response.headers["Access-Control-Allow-Origin"] = "https://journey-ease-site.vercel.app"
...
def login():
    ...
    response.headers.add("Access-Control-Allow-Origin", "https://journey-ease-site.vercel.app")
